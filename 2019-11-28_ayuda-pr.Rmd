...
## Por que user solicitudes de fusion?

Las solicitudes de fusion (__PR: _pull requests___) son el componente central de las contribuciones al codigo abierto. 
...
Las conexiones son complejas y es facil equivocarse.

<img src="https://i.imgur.com/3r95UJw.png" width=760 />

## Por que usethis?

[Las ayudantes para solicitudes de fusion de GitHub](https://usethis.r-lib.org/reference/pr_init.html): 
...
<img src="https://i.imgur.com/3VJY7JN.png" width=650 />
...
## La solucitud de fusion es aceptada
...
# "No subes al nivel de tus metas. Caes el nivel de tus sistemas." - [James Clear](https://jamesclear.com/atomic-habits)
