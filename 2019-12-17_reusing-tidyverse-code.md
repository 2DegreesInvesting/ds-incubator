...
## Resources
  ...
  - [Tidy eval in context, rstudio::conf 2019, Jenny
    Bryan](https://resources.rstudio.com/rstudio-conf-2019/lazy-evaluation).

  - [Reusing tidyverse code, UseR 2019, Lionel
    Henry](https://www.youtube.com/watch?v=C78fcsJmESI&feature=youtu.be).

  - [Advanced R, ed. 2, ch. 17-21, Hadley
    Wickham](https://adv-r.hadley.nz/).

  - [rlang package, Lionel Henry, Hadley
    Wickham](https://rlang.r-lib.org/).
