...
* What's nicer about PR from forks than branches from source repo?
    * pr vs branches: pr are branches, with additional, desirable features.
    * from fork betther than from source repo:
        * leads to better branch hygiene because the pr branch lives in the
          contributor's fork, so it does not contamine the source repo.
